                                ...
                                {notifications.length === 0 ? (
                                    ...
                                    <ul className="divide-y divide-slate-100">
                                        {notifications.map((notif, index) => {
                                            ...
                                            return (
                                                <li key={notif.notification_id || index} className={`px-4 py-3 cursor-pointer transition-colors ${isHighlighted ? 'bg-purple-50/50 hover:bg-purple-100/50' : 'hover:bg-slate-50'}`} onMouseDown={() => navigate('/my-requests')}>
