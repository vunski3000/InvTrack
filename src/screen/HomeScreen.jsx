    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/login" className="px-8 py-3 bg-white text-indigo-600 border border-indigo-600 text-lg font-medium rounded-lg shadow-md hover:bg-indigo-50 hover:shadow-lg transition-all duration-200 ease-in-out">
                    Login as Staff
                </Link>
            </div>
        </div>
